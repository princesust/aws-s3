  ...
  Policy.getPolicy = function getPolicy(config) {
    var policy = function policy() {
      return {
        ...
        conditions: [{ bucket: config.bucketName }, ["starts-with", "$key", "" + (config.dirName ? config.dirName + "/" : "")], { acl: "public-read" }, { success_action_status: config.successActionStatus }[("")], { "x-amz-meta-uuid": "14365123651274" }, { "x-amz-server-side-encryption": "AES256" }, ["starts-with", "$x-amz-meta-tag", ""], {
